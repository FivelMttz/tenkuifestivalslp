        ...
        <div className="relative overflow-hidden rounded-b-3xl mx-4 sm:mx-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="bg-cream p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
              <Link
                to="/#sedes"
                className="inline-flex items-center gap-2 text-warm-brown/60 hover:text-warm-brown text-sm mb-6 transition-colors"
              >
                <ArrowLeft className="w-4 h-4" />
                Volver a sedes
              </Link>
              <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-warm-brown mb-4 leading-tight">
                {sede.name}
              </h1>
              <p className="text-warm-brown/60 leading-relaxed mb-6">
                {sede.description}
              </p>
              <div className="flex flex-wrap gap-2">
                {sede.tags.map((tag) => (
                  <span key={tag} className="text-xs font-semibold bg-golden/20 text-warm-brown/80 px-4 py-1.5 rounded-full">
                    {tag}
                  </span>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-cream rounded-2xl p-8 space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs text-warm-brown/50">Ubicación</p>
                <p className="font-semibold text-warm-brown text-sm">{sede.address}</p>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm font-semibold text-warm-brown">Características</span>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-cream rounded-2xl p-8">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-serif text-lg font-bold text-warm-brown">Eventos en esta sede</h3>
              </div>
              <ul className="space-y-3">
                {sede.eventsHere.map((ev) => (
                  <li key={ev} className="text-sm text-warm-brown/70 bg-sage/30 px-4 py-2.5 rounded-xl">
                    {ev}
                  </li>
                ))}
              </ul>
