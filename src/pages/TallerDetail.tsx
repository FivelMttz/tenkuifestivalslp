        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            <div className="bg-cream rounded-2xl p-8">
              ...
              <p className="text-warm-brown/70 leading-relaxed text-base mb-6">
                {taller.description}
              </p>
              <div className="flex flex-wrap gap-2">
                {taller.tags.map((tag) => (
                  <span key={tag} className="text-xs font-medium bg-sage/50 text-warm-brown/70 px-3 py-1.5 rounded-full">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-sage-light rounded-2xl p-6 space-y-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-warm-brown">{taller.date}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-warm-brown">{taller.time}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-warm-brown">{taller.venue}</p>
                  <p className="text-xs text-warm-brown/50">{taller.venueAddress}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-warm-brown/50">Público</p>
                  <p className="font-semibold text-warm-brown">{taller.audience}</p>
                </div>
              </div>

              <div className="bg-accent/10 rounded-xl px-4 py-3 flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-accent" />
                <span className="text-sm font-medium text-accent">{taller.cost}</span>
              </div>
            </div>
